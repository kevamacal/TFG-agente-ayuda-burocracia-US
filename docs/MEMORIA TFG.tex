...
Como lenguaje principal se utilizó Python. Se tomó esta decisión de manera muy natural, dado que a día de hoy se considera que es el estándar en todo lo que rodea a la Inteligencia Artificial. Su ecosistema de bibliotecas es enorme y ofrece compatibilidad directa con las herramientas de orquestación que se detallan a continuación (LangChain, LangGraph), además de con prácticamente cualquier librería de procesamiento de datos que se requiera.
...
La base del éxito de cualquier sistema fundamentado en RAG reside en la calidad de la información alimentada al modelo. La documentación universitaria suele presentarse en formatos PDF complejos que contienen tablas extensas, layouts multicolumna y notas al pie, elementos que representan un obstáculo importante para los extractores de texto convencionales.
