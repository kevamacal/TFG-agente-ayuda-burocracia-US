...
Además de la monitorización en tiempo real, se implementó un script de evaluación offline automatizado en \texttt{evaluar\_rag.py} basado en el framework \textbf{Ragas}. Este framework evalúa de manera científica la calidad del pipeline RAG midiendo dos métricas esenciales utilizando un LLM como juez independiente (\texttt{llama-3.3-70b-versatile}):
\begin{enumerate}
