...
\begin{table}[H]
    ...
    \begin{tabular}{@{}llp{7cm}@{}}
        ...
        GET             & /admin/feedback/negativo                        & Listar feedback 👎 y referencias (Admin)      \\
...
A nivel de base de datos, implementamos roles diferenciados mediante la columna booleana \texttt{is\_admin} en la tabla de usuarios. Esto habilita dos niveles de permisos:
\begin{itemize}
