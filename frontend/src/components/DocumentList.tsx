            ...
            <form onSubmit={handleUploadSubmit} className="space-y-4">
              <div className="flex items-center justify-center rounded-lg border-2 border-dashed border-border/80 bg-inputBg px-6 py-6 transition-all hover:border-accent/40">
                <div className="text-center">
                  <Upload size={32} className="mx-auto text-textMuted mb-2" />
                  <div className="flex text-sm text-textMuted">
              ...
              {documents.map((doc, idx) => (
                ...
                >
                  <div className="flex items-center space-x-4 min-w-0">
                    <div className="rounded-lg bg-inputBg border border-border p-2.5 text-textMuted">
                      <FileText size={20} />
                    </div>
                  ...
                  {isAdmin && (
                    <button
                      ...
                      className="rounded-lg border border-border/80 bg-background p-2.5 text-accent hover:bg-accent hover:text-white transition-all shadow-sm"
